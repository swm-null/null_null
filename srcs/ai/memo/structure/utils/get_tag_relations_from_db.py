...
from ai.utils.database.collections.tag_edges import tag_edges_collection, UID_FIELD_NAME


async def get_tag_relations_from_db(user_id: str) -> defaultdict[str, list[str]]:
