...
from ai.search.db_search.utils import keyword_query_generator, perform_keyword_query_by_keyword, perform_query_by_vector
...
async def search_memo_using_db(query: str, user_id: str, lang: str="Korean") -> Res_post_search_db:
    ...
    start_time, end_time=_convert_timezone(generated_query.start_time, generated_query.end_time, lang)
...
def _convert_timezone(start_time: datetime | None, end_time: datetime | None, lang: str) -> tuple[datetime, datetime]:
